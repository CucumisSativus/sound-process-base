...
void GnuplotPlotter::plot2d(PointsVector2d points) {
    ...
    std::string setPlot1 = std::string(std::string("plot '") + filename + std::string("' using 1 title 'Function',"));
    std::string setPlot2 = std::string(std::string("'") + filename + std::string("' using 2 title 'Samples'\";"));
